...
public class CodeGenerator {
	...
	private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/meet-data/src/test/resources/template";
	...
	public static void main(String[] args) {
		//单个数据表配置genCodeByCustomModeName
		genCodeByCustomModeName("t_reserve_meet",null,null);
	}
	...
	public static void genService(String modelName,String packageName){
		String projectName = "meet-service";
		try {
